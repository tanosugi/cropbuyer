...
export default function FarmCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setGrowerName(initialValues.growerName);
    setArea(initialValues.area);
    setLatestStatus(initialValues.latestStatus);
    setPolygonString(initialValues.polygonString);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Farm(modelFields));
          if (onSuccess) {
