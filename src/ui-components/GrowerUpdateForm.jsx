...
export default function GrowerUpdateForm(props) {
  const {
    id: idProp,
    grower: growerModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = growerRecord
      ? { ...initialValues, ...growerRecord }
      : initialValues;
  ...
  const [growerRecord, setGrowerRecord] = React.useState(growerModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Grower, idProp)
        : growerModelProp;
      setGrowerRecord(record);
    };
    queryData();
  }, [idProp, growerModelProp]);
  React.useEffect(resetStateValues, [growerRecord]);
  const validations = {
    name: [],
    email: [],
    phone: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Grower.copyOf(growerRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "GrowerUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || growerModelProp)}
