...
export default function PersonalSettingCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setMapLat(initialValues.mapLat);
    setMapLng(initialValues.mapLng);
    setMapZoom(initialValues.mapZoom);
    setMapTilt(initialValues.mapTilt);
    setMapRotate(initialValues.mapRotate);
    setErrors({});
  };
  const validations = {
    mapLat: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new PersonalSetting(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "PersonalSettingCreateForm")}
      {...rest}
    >
      <TextField
        label="Map lat"
